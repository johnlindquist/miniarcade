...
async function main(){
  ...
  const report={
    ...
    metrics:{candidate:candidateMetrics,horizon:horizonMetrics,blockmine:blockmineMetrics,
      ...
      warningContrast,stormBurst,shrinkDelta,slashDelta,shardDelta,squishBurst,bloomDelta,channelBurst,restoreDelta,restoreBurst,gateDelta,tellDelta,chargeBurst,dodgeDelta,parryDelta,noVisiblePath},
