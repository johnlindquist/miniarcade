...
if(!index.includes('seventeen tiny games'))fail('gallery count copy is stale');
...
for(const tone of ['sy','af','tl','cc','mb'])if(!index.includes(`.${tone}{--accent:`))fail(`${tone} gallery tone is missing`);
