...
if(games.length!==12||ids.size!==games.length)fail('manifest must contain twelve unique game ids');
...
if(!index.includes('twelve tiny games'))fail('gallery count copy is stale');
...
if(!readme.includes('twelve self-playing'))fail('runtime README count is stale');
