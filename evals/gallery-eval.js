...
if(games.length!==30||ids.size!==games.length)fail('manifest must contain thirty unique game ids');
...
if(!index.includes('>01 / 30</output>')||index.includes('>01 / 29</output>'))
...
if(!readme.includes('Thirty self-playing'))fail('runtime README count is stale');
