...
if(games.length!==11||ids.size!==games.length)fail('manifest must contain eleven unique game ids');
...
if(!index.includes('eleven tiny games'))fail('gallery count copy is stale');
...
if(!readme.includes('eleven self-playing'))fail('runtime README count is stale');
